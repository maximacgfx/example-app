            ...
            <div class="col-sm-6">
              <div class="nav-top-contact">
                ...
                <ul class="list-inline text-center text-md-left mb-0">
                  <li class="list-inline-item mx-2" ><i class="fa fa-phone"></i><a href="tel:{{ config('company.office-phone')}}">{{ config('company.office-phone')}}</a></li>
                    <li class="list-inline-item mx-2" ><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:{{ config('company.email')}}">{{ config('company.email')}}</a></li>
                </ul>
              </div>
            </div>
