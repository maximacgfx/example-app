<footer class="wt-section bg-dark main-footer">
    ...
    <li class="list-block-item mx-2"><a href="#">{{ __('menu.home') }}</a></li>
    <li class="list-block-item mx-2"><a href="#">{{ __('menu.about') }}</a></li>
    <li class="list-block-item mx-2"><a href="#">{{ __('menu.services') }}</a></li>
    <li class="list-block-item mx-2"><a href="#">{{ __('menu.portfolio') }}</a></li>
    <li class="list-block-item mx-2"><a href="#">{{ __('menu.pricing') }}</a></li>
    </ul>
    ...
    <ul class="list-inline">
    <li class="list-block-item mx-2"><a href="#">{{ __('menu.blog') }}</a></li>
    <li class="list-block-item mx-2"><a href="#">{{ __('menu.contact') }}</a></li>
    <li class="list-block-item mx-2"><a href="#">{{ __('menu.policy') }}</a></li>
