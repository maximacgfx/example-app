...
<div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbar-blog">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                @else
                    ...
                    <li class="nav-item">
                        ...
                        document.getElementById('magic-form').submit();" href="">Выйти</a>
                    </li>
            ...
            <form id="magic-form" action="{{ route('logout') }}" 
      method="POST" style="display: none;">
      @csrf <!-- from your framework -->
