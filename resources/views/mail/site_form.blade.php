	...
	<tr>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
                        <h3>Hi, {{ $mail_env['sender_name']}}</h3>
                        <p>{{ $mail_env['subject']}}</p>
						<p class="lead">{{ $details['message']}}</p>
								...
								<td>
									...
									<table align="left" class="column">
										<tr>
                                            ...
                                            <p>Phone: <strong>{{ env('company.mobile-phone') }}</strong><br/>
                                            <p>Phone: <strong>{{ env('company.office-phone') }}</strong><br/>
                Email: <strong><a href="emailto:{{ env('company.email') }}">{{ env('company.email') }}</a></strong></p>
